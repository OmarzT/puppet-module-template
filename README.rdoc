...
- *via top-level-scope variables or in hiera*
...
By the way: Each module may have defaults for a certain parameter. Those
are defined in modulename::params (manifests/params.pp)
